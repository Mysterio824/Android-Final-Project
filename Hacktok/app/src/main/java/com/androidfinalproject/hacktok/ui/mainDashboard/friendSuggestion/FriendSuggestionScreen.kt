    ...
    LazyColumn(
        ...
        item {
            FriendRequestsSection(
                ...
                onAccept = { userId -> onAction(FriendSuggestionAction.HandleRequest(userId, true)) },
                onDecline = { userId -> onAction(FriendSuggestionAction.HandleRequest(userId, false)) },
        ...
        items(filterSuggestedFriends(state.users, state.relations)) { user ->
            ...
            SuggestedFriendItem(
                ...
                onUnSendRequest = { onAction(FriendSuggestionAction.UnSendRequest(user.id ?: "")) },
